	...
	<div class="content-top">
		...
		<c:forEach items="${goodsList}" var="g">
			<div class="col-md-4 grid-top">
				<a href="Goods/findGoodsList.do?id=${g.goodsid}" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="${g.goodsphoto}" alt="">
							<div class="b-wrapper">
			...
			<p><a href="Goods/findGoodsList.do?id=${g.goodsid}">${g.goodsname}</a></p>
			</div>
			</c:forEach>
			<!-- <div class="col-md-4 grid-top">
